      ...
      <main id="stage" className="min-h-screen px-4 py-10 md:px-8 max-w-4xl mx-auto">
        ...
        <section className="mt-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <a href="/menus/feeds/bluesky#stage" className="card rounded-xl p-5 flex items-center gap-4 hover:border-accent transition-colors">
          ...
          <p className="text-sm text-[var(--color-text-secondary)] mb-4 max-w-prose pretty">
            Import from recipe communities directly inside the app via <a href="/recipes/import#stage" className="underline hover:text-accent">Recipes &rarr; Import</a>.
          </p>
