...
/**
 * Standalone Bluesky Recipes feed page — adds page chrome (breadcrumb +
 ...
 * legacy deep links that used to land here. (The web Layout supplies the
 * <main id="stage"> wrapper, so this returns a plain div.)
 */
